...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'IATEmpresa'.
	/// </summary>
	public class cIATEmpresaNegocios : cIATEmpresaDatos
	{
		...
		/// </summary>
		public cIATEmpresaNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cIATEmpresa;"
					+"Nom_Empresa:"+Nom_Empresa.ToString()+";"
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cIATEmpresa;"
